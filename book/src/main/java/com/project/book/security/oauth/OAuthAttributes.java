...
import com.project.book.security.oauth.userinfo.KakaoOAuth2UserInfo;
import com.project.book.security.oauth.userinfo.OAuth2UserInfo;
...
public class OAuthAttributes {
	 ...
	 * 소셜별 of 메소드(ofKaKao, ofGoogle)들은 각각 소셜 로그인 API에서 제공하는
